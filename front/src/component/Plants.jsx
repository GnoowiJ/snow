...
import {
  ...
  handleNextPage,
  handlePageClick,
} from "../handle/paginationHandlers.js";
...
export default function SpecialDay() {
  const [selectedCategory, setSelectedCategory] = useState("인테리어 식물");
  ...
  return (
    <div>
      <div className="image-container">
        <p>
          <img
            src="https://snowfoxflowers.com/web/upload/category/shop1_25_top_235965.jpg"
            alt="best-seller"
          />
        </p>
      </div>
      <div className="category-list">
        <ul>
          {["인테리어 식물", "대형 식물", "동/서양난", "화환"].map((category) => {
